...
const LandingPage = () => {
    ...
    return (
        <div className="flex w-full h-full items-center p-24 relative">
            ...
            <h1 className="ml-auto w-[45%] text-[60px] text-white relative z-1 font-serif font-light leading-none mr-20">Boldhaven Management is  <br />a fundamental <br /> investment manager based in London</h1>
            <svg xmlns="http://www.w3.org/2000/svg" className="absolute z-100 bottom-20 z-10 right-[calc(37%)]" width="28" height="28" viewBox="0 0 28 28" fill="none">
            ...
            <div className="h-[420px] w-[1px] bg-highlight absolute bottom-[calc(0px-338px)] rotate-180 z-10 right-[calc(37.9%)]" />
        </div>
    );
};
