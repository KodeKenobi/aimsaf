...
export default function Navigation() {
    return (
        <div className="flex justify-between items-center bg-red-200 md:px-20 px-8 h-16 md:h-32 absolute w-full bg-secondary z-20 top-0 left-0">
            ...
            <div className="md:flex hidden justify-between items-center gap-20 text-white relative text-sm">
                ...
                <Link className="py-6" href={''}>ABOUT</Link>
                <Link className="py-6" href={''}>PHILOSOPHY</Link>
                <Link className="py-6" href={''}>CONTACT</Link>
