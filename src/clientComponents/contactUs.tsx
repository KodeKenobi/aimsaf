        ...
        <div className="flex flex-col w-full h-full justify-center relative bg-contact bg-cover p-20 pb-0" id="contact">
            <div className="grid grid-cols-2">
                <div>
                    ...
                    <motion.h3
                        className="text-[60px] text-white relative z-1 font-serif font-light leading-none mb-10"
            ...
            <motion.div
                className="bg-transparent w-full py-6 pt-12 flex lg:flex-row flex-col items-center justify-between xl:px-12 2xl:px-12 border-[#ffffff15] border-t mt-auto"
