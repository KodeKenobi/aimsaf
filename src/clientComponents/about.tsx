    ...
    return (
        <div className="flex w-full h-full items-center relative text-primary" id="about">
            ...
            <div className="w-[70%] h-full bg-white p-20 flex flex-col justify-center ">
                ...
                <motion.h3 className="text-[60px] leading-none text-primary font-serif mb-4"
                ...
                <motion.p
                    ...
                    className="text-sm mt-4 font-semibold">Boldhaven is an alternative investment management firm founded in 2017 and based in London.
                </motion.p>
                <motion.p
                    initial={{ opacity: 0, x: -10 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ ease: "easeInOut", duration: 0.7, delay: 1.4 }}
                    className="text-sm mt-4">We manage a concentrated strategy focused on long and short opportunities in Europe.
                </motion.p>
                <motion.p
                    initial={{ opacity: 0, x: -10 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ ease: "easeInOut", duration: 0.7, delay: 1.6 }}
                    className="text-sm mt-4">Our approach, led by Ronald Sofer (Founder & CIO), is defined by deep fundamental research,a long-term investment horizon and focus on intrinsic value.
                </motion.p>
            </div>
        </div>
    );
